        ...
        <div class="flex items-center justify-between h-16 lg:h-18">
            ...
            <div class="hidden lg:flex items-center gap-0.5">
                ...
                <div class="relative" x-data @click.outside="products = false">
                    ...
                    >
                        {{-- Eduvisee --}}
                        <div class="flex items-start gap-3 px-4 py-3 hover:bg-slate-50 cursor-default" role="menuitem" onclick="window.location.href='https://eduvisee.com';">
                            ...
                            <div>
                                <p class="text-sm font-semibold text-slate-900">Eduvisee</p>
